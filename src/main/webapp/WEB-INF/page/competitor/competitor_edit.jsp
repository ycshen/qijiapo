    ...
    <div class="container" style="margin-top: 50px;">
        ...
        <div class="layui-form-item my-layui-form-item">
            ...
            <div class="layui-form-item my-layui-form-item my-top">
                ...
                <div class="layui-input-block">
                    <input type="num" name="postcode" autocomplete="off" value="${competitor.postcode}"
            ...
            <div class="layui-form-item my-layui-form-item my-top">
                ...
                <div class="layui-input-block">
                    <input type="text" name="staffNum" autocomplete="off" value="${competitor.staffNum}"
                           placeholder="请输入总人数" class="layui-input" maxlength="10">
                </div>
            </div>
            <div class="layui-form-item my-layui-form-item my-top">
                <label class="layui-form-label">上年销售额</label>
                <div class="layui-input-block">
                    <input type="num" name="saleMoney" autocomplete="off" value="${competitor.saleMoney}"
