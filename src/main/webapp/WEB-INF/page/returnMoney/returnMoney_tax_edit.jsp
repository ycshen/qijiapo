...
<form class="layui-form" id="myForm" onsubmit="return false;">
    ...
    <div class="container" style="margin-top: 50px;">
        ...
        <div class="layui-form-item my-layui-form-item my-top">
            <label class="layui-form-label">票据内容<span style="color:red">*</span></label>
            <div class="layui-input-block">
         ...
         <div class="layui-form-item my-layui-form-item my-top">
            <label class="layui-form-label">金额（元）<span style="color:red">*</span></label>
            <div class="layui-input-block">
                <input type="text" name="money" lay-verify="money" autocomplete="off" placeholder="请输入计划回款金额" class="layui-input"  value="${customer.mobile}">
            </div>
        </div>
        <div class="layui-form-item my-layui-form-item my-top">
            <label class="layui-form-label">开票日期<span style="color:red">*</span></label>
            <div class="layui-input-block">
                <input type="text" name="returnMoneyTime" lay-verify="returnMoneyTime"
                       autocomplete="off" placeholder="请输入开票日期" class="layui-input"
        ...
        <div class="layui-form-item my-layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <select name="contractType" lay-search="" >
                        ...
                        <option value="1" <c:if test="${contract.contractType == 1}">selected</c:if>>增值税</option>
                        <option value="2" <c:if test="${contract.contractType == 2}">selected</c:if>>普通国税</option>
                        <option value="3" <c:if test="${contract.contractType == 3}">selected</c:if>>普通地税</option>
                        <option value="4" <c:if test="${contract.contractType == 4}">selected</c:if>>增值税专用发票</option>
                        <option value="5" <c:if test="${contract.contractType == 5}">selected</c:if>>增值税普通发票</option>
                    </select>
                </div>
            </div>
        <div class="layui-form-item my-layui-form-item my-top">
            <label class="layui-form-label">发票号码<span style="color:red">*</span></label>
            <div class="layui-input-block">
                <input type="text" name="money" lay-verify="money" autocomplete="off" placeholder="请输入发票号码" class="layui-input"  value="${customer.mobile}">
            </div>
        </div>
        
        <div class="layui-form-item my-layui-form-item my-top">
            <label class="layui-form-label">经手人<span style="color:red">*</span></label>
            <div class="layui-input-block">
                <select name="userId"  lay-search="" lay-verify="userId">
                    <option value="">搜索或者选择经手人</option>
