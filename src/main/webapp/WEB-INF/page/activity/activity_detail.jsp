...
<head>
    ...
    <script type="text/javascript" src="${ctx}/js/pages/activity/activity_detail.js"></script>
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        <table class="table my-table" id="detailTable">
                            ...
                            <tr>
                                <td class="title-td">市场活动名称:</td>
                                <td>${activity.activityName}</td>
                                <td class="title-td">市场活动所属人:</td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">${activity.remark}</td>
                            ...
                            <div class="layui-field-box">
                                <div class="layui-btn-group">
                                    <button class="layui-btn layui-btn-primary"
                                            onclick="transfer('${activity.id}', '${activity.activityName}');">
                                        <i class="layui-icon">&#xe620;</i>转移给他人
                                    </button>
                                    <button class="layui-btn layui-btn-primary"
                                            onclick="deleteById('${activity.id}','${activity.activityName}');">
                        ...
                        <fieldset class="layui-elem-field">
                            ...
                            <div class="layui-field-box">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs">${activity.userName}</span>
                                </a>
