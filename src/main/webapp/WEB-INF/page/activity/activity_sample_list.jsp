...
<head>
    ...
    <script src="${ctx}/js/pages/activity/activity_sample_list.js"></script>
    <style type="text/css">
        .mybox {
            margin-bottom: 0px;
        }
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box mybox">
                    ...
                    <form class="layui-form" onsubmit="return false;">
                        <table class="table mytable">
                            <tr>
                                ...
                                <%--</td>--%>
                                <%--<td><input type="text" class="layui-input my-input" id="txtMobile" placeholder="电话">--%>
                                <%--</td>--%>

                                <td colspan="2">
                                    <button class="layui-btn layui-btn-primary" onclick="queryActivity();">
                ...
                <div class="box-body"
                     style="height: 220px; width: 750px;overflow-y: auto;overflow-x: hidden;padding:0px;">
                ...
                <div class="layui-form-item my-top" style="margin-top: 5px;">
                    <div class="layui-input-block" style="text-align:right;">
                        <button class="layui-btn" lay-submit="" lay-filter="mySubmit" onclick="confirmSelect();">确定选择
                        </button>
                        <button class="layui-btn layui-btn-primary" style="margin-right:50px;" onclick="cancelEdit();">
                            取消选择
                        </button>
                    </div>
                </div>
