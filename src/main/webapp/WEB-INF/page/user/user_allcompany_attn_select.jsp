...
<body>
  ...
  <div class="layui-form-item">
    <div class="layui-input-block" style="text-align: right;">
      <button class="layui-btn" type="button"  onclick="transferAttn('${id}');">确定</button>
...
<script type="text/javascript" src="${ctx}/js/pages/user/user_allcompany_attn_select.js"></script>
