...
<script src="${ctx}/js/pages/customer/customer_list.js"></script>
<style type="text/css">
	.mybox{
		margin-bottom: 0px;
	}
          ...
          <div class="box mybox">
            <div class="box-body my-box-body">
            		<form class="layui-form"  onsubmit="return false;">
	          		<table class="table mytable">
						  ...
						  <button class="layui-btn layui-btn-primary" onclick="addCustomer();">
            ...
            <div class="box-body">
              <table id="myDataTable" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th><input type="checkbox" name="customer-list-checkable" id="chkAll"></th>
                  <th>操作</th>
                  <th>客户名称</th>
                  <th>客户级别</th>
                  <th>总人数</th>
