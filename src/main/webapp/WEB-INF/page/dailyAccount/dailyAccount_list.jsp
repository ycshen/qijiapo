...
<script src="${ctx}/js/pages/dailyAccount/dailyAccount_list.js"></script>
<style type="text/css">
	.mybox{
		margin-bottom: 0px;
	}
            		...
            		<form class="layui-form"  onsubmit="return false;">
	          		<table class="table mytable">
	          			<tr>
	          				...
	          				<label class="layui-form-label my-label">日常账号</label>
		          				
						  </td>
						  <td><input type="text" class="layui-input my-input" id="txtDailyAccountName" placeholder="账号"></td>
				  		...
				  		<div class="layui-btn-group">
					  	  <button class="layui-btn layui-btn-primary" onclick="queryDailyAccount();">
							<i class="layui-icon">&#x1002;</i>查询
							
						  </button>
						  <button class="layui-btn layui-btn-primary" onclick="addDailyAccount();">
						    <i class="layui-icon">&#xe61f;</i>新增日常账号
						  </button>
