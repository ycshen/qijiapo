...
function batchTransfer() {
    ...
    if (isNotBlank(idArr)) {
        layer.confirm("确定要批量转移联系人相关信息吗？", {
            closeBtn: false,
            skin: 'layui-layer-molv'
        }, function () {
            var url = ctx + "/inner/user/selectAllUserAttn?id=" + idArr;
            var title = "批量转移联系人";
            layer.open({
                type: 2,
                title: title,
...
function deleteById(id, name) {
    layer.confirm("确定要删除联系人【" + name + "】相关信息吗？", {
        closeBtn: false,
        skin: 'layui-layer-molv'
    }, function () {
