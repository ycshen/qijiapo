...
function queryActivity(){
	...
	$("#myDataTable").dataTable( {
        ...
        "columns": [
            ...
            { data: 'activityName',render: function(data, type, activity){
                return renderActivity(activity.id, activity.activityName);
            }},
            ...
            { data: 'provinceName',
                render: function(data, type, activity){
                    return renderPCA(activity.provinceName, activity.cityName, activity.areaName);
                }
            }
        ],
...
function renderActivity(id, name){
	return "<span id='activityName" + id + "'>" +  name +"</span>";
}
...
function confirmSelect(){
	...
	if(isBlank(id)){
		...
		if(id.indexOf(",") > 0){
			...
			var name = $("#activityName" + id).html();
			parent.getActivity(id, name);
		}
	}
