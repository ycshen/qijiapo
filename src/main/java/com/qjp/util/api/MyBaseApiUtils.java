...
public class MyBaseApiUtils {
	...
	public static String getAllDepByCompanyId(String id){
		String result = StringUtils.EMPTY;
		try {
			String url = getMyBaseUrl() + MyBaseApiUrl.mybase_getAllDepByCompanyId;
			Map<String,Object> maps = SHA1Utils.getSha1Map();
			maps.put("id", id);
	...
	public static String getAllOutterMenu(String definedType, String casecadeId, String companyId){
		String result = StringUtils.EMPTY;
		try {	
	...
	public static String getSubDepIdList(String companyId, String departmentId){
		String result = StringUtils.EMPTY;
		try {	
			String url = getMyBaseUrl() + MyBaseApiUrl.mybase_getSubDepIdList;
			Map<String,Object> maps = SHA1Utils.getSha1Map();
			maps.put("companyId", companyId);
			maps.put("departmentId", departmentId);
			String secret = SHA1Utils.SHA1(maps);
