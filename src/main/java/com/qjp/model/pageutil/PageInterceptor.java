...
public class PageInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        MetaObject metaStatementHandler = MetaObject.forObject(statementHandler, DEFAULT_OBJECT_FACTORY,
                DEFAULT_OBJECT_WRAPPER_FACTORY, DEFAULTREFLECTORFACTORY);
        MappedStatement mappedStatement = (MappedStatement) metaStatementHandler.getValue("delegate.mappedStatement");
        if (pageSqlId == null || !mappedStatement.getId().matches(pageSqlId)) {
        ...
        if (obj instanceof Page<?>) {
            ...
            if (page.getIsPage()) {
				...
				/*
				 * MappedStatement mappedStatement1 = (MappedStatement)
                ...
                // 给当前的page参数对象设置总记录数
                // this.setTotalRecord(page, mappedStatement1, connection);
    ...
    private String getMysqlPageSql(Page<?> page, StringBuffer sqlBuffer) {
        ...
        if (StringUtils.isEmpty(page.getParams().get("pageStatus"))) {
    ...
    private String getOraclePageSql(Page<?> page, StringBuffer sqlBuffer) {
        ...
        int offset = (page.getPage() - 1) * page.getSize() + 1;
        sqlBuffer.insert(0, "select u.*, rownum r from (").append(") u where rownum < ")
                .append(offset + page.getSize());
